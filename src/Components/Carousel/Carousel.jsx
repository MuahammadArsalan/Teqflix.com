...
<div  id='carousel-div' className="carousel carousel-vertical h-96" >
 <div className="carousel-item h-full">     <img src="./Images/img.jpg" />
 </div>  <div className="carousel-item h-full">     <img src="./Images/img1.jpg" />
 </div>
 <div className="carousel-item h-full">
    <img src="./Images/img2.jpg" />
  </div>  <div className="carousel-item h-full">    <img src="./Images/img3.jpg" />
  </div>
  <div className="carousel-item h-full">
   <img src="./Images/img4.jpg" />
  </div>  <div className="carousel-item h-full">
    <img src="./Images/img5.jpg" />  </div>  <div className="carousel-item h-full">
    <img src="./Images/img6.jpg" />  </div> </div>
 </div>
